...
<body>
  ...
  <section class="position-relative vh-100 overflow-hidden">
    ...
    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center text-center text-white px-3 bg-dark bg-opacity-50">
