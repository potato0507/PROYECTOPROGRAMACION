...
<body>
  ...
  <main>
    ...
    <section class="position-relative vh-100 overflow-hidden">
      ...
      <div id="textoIntro" class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center text-center text-white px-3 bg-dark bg-opacity-50">
      ...
      <div class="container">
        <div class="row g-4 align-items-center">
          ...
          <div class="col-lg-6">
            ...
            <p>
              La energía hidráulica es un tipo de energía que aprovecha el movimiento del agua. También llamada energía hídrica,
              permite obtener electricidad gracias al aprovechamiento de la energía cinética y potencial de las corrientes o saltos de agua.
            </p>
            <p>
              Se trata de una energía limpia y renovable que utiliza la fuerza de arroyos, ríos y saltos de agua. Comúnmente, se asocia con las
              centrales hidroeléctricas ubicadas en presas o embalses.
            </p>
          </div>
        ...
        <div class="row g-4 align-items-center">
          ...
          <div class="col-lg-6 text-center">
            <img src="videos/central hidroelectrica.jpg" alt="Esquema de funcionamiento de una central hidroeléctrica"
              class="img-fluid rounded shadow w-100 object-fit-cover" style="max-height: 400px;">
          </div>
        </div>
      </div>
    </section>
