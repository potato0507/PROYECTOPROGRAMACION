<!-- FOOTER -->
<footer class="text-white py-4" style="background-color:#0369A1;">
  <div class="container">
    <div class="row align-items-center gy-3">

      <!-- Logo / Nombre del sitio -->
      <div class="col-md-4 text-center text-md-start">
        <h5 class="fw-bold mb-0 text-white">HidroEnergía</h5>
        <small class="text-white-50">Impulsando un futuro sostenible</small>
      </div>
...
<div class="col-md-4 text-center text-md-end">
  <div class="d-flex justify-content-center justify-content-md-end align-items-center">
    ...
    <div class="text-center small text-white-50">
      © 2025 HidroEnergía. Todos los derechos reservados.
    </div>
  </div>
</footer>